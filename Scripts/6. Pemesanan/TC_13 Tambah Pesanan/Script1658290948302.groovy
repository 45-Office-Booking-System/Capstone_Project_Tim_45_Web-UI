...
WebUI.setText(findTestObject('Pemesanan/Tambah Pesanan/nama'), 'Si A Paja')
...
WebUI.setText(findTestObject('Pemesanan/Tambah Pesanan/total harga'), 'Rp 4.500.000')

WebUI.setText(findTestObject('Pemesanan/Tambah Pesanan/tanggal masuk'), '18-07-2022')

WebUI.setText(findTestObject('Pemesanan/Tambah Pesanan/tanggal keluar'), '20-07-2022')
